...
CREATE TABLE ALUMNOS (  --TODO: ACTUALIZAR TABLA ALUMNOS, HE MOVIDO EL NICKNAME
...
CREATE TABLE PERFIL_ALUMNOS ( --TODO: ACTUALIZAR TABLA PERFIL_ALUMNOS, HE MOVIDO EL NICKNAME
    ID_alumno INT PRIMARY KEY,
    ...
    FOREIGN KEY (Avatar_id) REFERENCES IMAGENES_AVATAR(ID_avatar) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (ID_set) REFERENCES CONJUNTOS(ID_set) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE INTERACCION_ALUMNOS (  --TODO: ACTUALIZAR TABLAS, HE CAMBIADO LA FOREING KEY A PERFIL_ALUMNOS EN VEZ DE ALUMNOS
...
CREATE TABLE FORMATOS_ALUMNOS ( --TODO: ACTUALIZAR TABLAS, HE CAMBIADO LA FOREING KEY A PERFIL_ALUMNOS EN VEZ DE ALUMNOS
    ID_alumno INT NOT NULL,
...
CREATE TABLE IMAGENES_AVATAR (
    ID_avatar INT PRIMARY KEY,
    FOREIGN KEY (ID_avatar) REFERENCES IMAGENES(ID_imagen) ON DELETE CASCADE ON UPDATE CASCADE
);
